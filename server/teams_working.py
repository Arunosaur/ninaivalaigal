...
async def get_my_teams(
    ...
    return {"success": True, "teams": teams, "count": len(teams), "user_id": user_id}


@router.get("/create")
async def create_team(
    name: str, description: str = "", user: Dict[str, Any] = Depends(get_current_user)
) -> Dict[str, Any]:
...
async def add_team_member(
    ...
    if existing_membership:
        return {"success": False, "error": f"User '{email}' is already a team member"}
    ...
    return {
        ...
        "new_member": {**target_user, "role": role},
        "added_by": user["email"],
    }
...
async def promote_member(
    ...
    return {
        ...
        "promoted_member": {**target_user, "role": "team_admin"},
...
async def demote_member(
    ...
    return {
        ...
        "demoted_member": {**target_user, "role": "member"},
