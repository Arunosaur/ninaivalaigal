...
class ShellInjectionPrevention:
    ...
    def safe_subprocess_run(self, command: Union[str, List[str]], **kwargs) -> subprocess.CompletedProcess:
    ...
    def _get_secure_env(self, user_env: Optional[Dict[str, str]] = None) -> Dict[str, str]:
...
def safe_run_command(command: Union[str, List[str]], **kwargs) -> subprocess.CompletedProcess:
