...
async def health_system_status():
    ...
    try:
        ...
        return {"status": "unhealthy", "service": "memory-health-api", "error": str(e)}
...
async def trigger_maintenance_scan(
    ...
    try:
        ...
        background_tasks.add_task(_perform_maintenance_scan, current_user.id)
...
async def _perform_maintenance_scan(user_id: int):
    ...
    try:
        ...
        logger.error("Maintenance scan failed", user_id=user_id, error=str(e))
