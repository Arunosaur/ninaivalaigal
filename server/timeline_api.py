...
TIMELINE_EVENTS = [
    {
        ...
        "metadata": {"memory_type": "text", "scope": "personal"},
    },
    {
        "id": 2,
        ...
        "metadata": {"memory_type": "text", "scope": "team"},
    },
    {
        "id": 3,
        ...
        "metadata": {"context_type": "project", "scope": "team"},
    },
    {
        "id": 4,
...
def filter_events_by_access(
    ...
    for event in events:
        ...
        if event.get("team_id") is None:
            can_view = event["user_id"] == user_id or user_role in [
                "admin",
                "org_admin",
            ]
