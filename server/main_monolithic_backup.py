...
from database import (Context, ContextPermission, DatabaseManager, TeamMember,
                      User)
...
from rbac_middleware import (get_rbac_context, rbac_middleware,
                             require_permission)
from redis_client import redis_client
from redis_queue import queue_manager
from security_integration import (configure_security, log_admin_action,
                                  redact_text)
...
def get_prometheus_metrics():
    ...
    try:
        from security.monitoring.grafana_metrics import \
