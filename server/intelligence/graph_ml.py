...
from .models import (
    ...
    UserFeedback, WeightUpdate, GraphMLMetrics
)
...
class GraphMLEngine:
        ...
        try:
            ...
            for memory in candidate_memories:
                ...
                confidence = self._calculate_prediction_confidence([
                    content_score, centrality_score, temporal_score, 
                    context_score, collaboration_score, feedback_score
                ])
    ...
    async def _extract_graph_features(self, memory: Dict, context: GraphContext) -> Dict[str, float]:
        ...
        features['collaboration_strength'] = await self._calculate_collaboration_strength(
            memory, context.team_context
        )
    ...
    def _generate_reasoning(self, *scores) -> List[str]:
        ...
        content_score, centrality_score, temporal_score, context_score, collab_score, feedback_score = scores
    ...
    def _update_ml_metrics(self, processed_count: int, processing_time: float):
        ...
        self.metrics.processing_latency_ms = (
            ...
            (1 - alpha) * self.metrics.processing_latency_ms
        )
        ...
        if processing_time > 0:
            ...
            self.metrics.throughput_qps = (
                alpha * current_qps + 
                (1 - alpha) * self.metrics.throughput_qps
            )
