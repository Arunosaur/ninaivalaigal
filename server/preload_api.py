...
async def trigger_preloading(
    ...
    try:
        ...
        logger.info("Manual preloading triggered", 
                   user_id=user_id,
        ...
        logger.error("Error triggering preloading", 
                    user_id=current_user.user_id, 
                    error=str(e))
...
async def get_preloading_status(
    ...
    try:
        ...
        logger.error("Error getting preloading status", 
                    user_id=current_user.user_id, 
                    error=str(e))
        raise HTTPException(status_code=500, detail=str(e))
...
async def get_preloaded_memory_endpoint(
    ...
    try:
        ...
        if not memory:
            raise HTTPException(
                status_code=404,
                detail=f"Preloaded memory {memory_id} not found"
            )
        
        logger.debug("Preloaded memory retrieved",
                    user_id=current_user.user_id,
                    memory_id=memory_id)
...
async def trigger_background_warming(
    ...
    try:
        ...
        if not current_user.is_admin:
            raise HTTPException(
                status_code=403,
                detail="Admin access required for background warming"
            )
        ...
        logger.error("Error triggering background warming", 
                    user_id=current_user.user_id, 
                    error=str(e))
        raise HTTPException(status_code=500, detail=str(e))
...
async def get_preloading_config(
    ...
    try:
        ...
        logger.error("Error getting preloading config", 
                    user_id=current_user.user_id, 
                    error=str(e))
        raise HTTPException(status_code=500, detail=str(e))
...
async def update_preloading_config(
    ...
    try:
        ...
        if not current_user.is_admin:
            raise HTTPException(
                status_code=403,
                detail="Admin access required to update configuration"
            )
        ...
        logger.info("Preloading configuration updated",
        ...
        logger.error("Error updating preloading config",
                    user_id=current_user.user_id,
                    error=str(e))
        raise HTTPException(status_code=500, detail=str(e))
...
async def get_preloading_stats(
    ...
    try:
        ...
        logger.error("Error getting preloading stats",
                    user_id=current_user.user_id,
                    error=str(e))
        raise HTTPException(status_code=500, detail=str(e))
...
async def clear_preloaded_cache(
    ...
    try:
        ...
        if keys:
            ...
            logger.info("Preloaded cache cleared",
                       user_id=current_user.user_id,
        ...
        logger.error("Error clearing preloaded cache",
                    user_id=current_user.user_id,
                    error=str(e))
        raise HTTPException(status_code=500, detail=str(e))
