...
from auth_utils import get_current_user, require_role, require_account_type
...
async def get_org_settings(user: Dict[str, Any] = Depends(require_account_type("organization"))):
