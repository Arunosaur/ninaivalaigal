...
class EnhancedJSONAuthMiddleware(BaseHTTPMiddleware):
    ...
    async def _validate_authentication(self, request: Request) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"valid": True, "error": None, "user": user}
    ...
    async def _process_json_body(self, request: Request) -> Dict[str, Any]:
        ...
        try:
            ...
            if content_length and int(content_length) > 0:
                ...
                if body_bytes:
                    try:
                        ...
                        return {"valid": True, "error": None, "data": json_data}
            ...
            return {"valid": True, "error": None, "data": None}
...
class RBACEnhancedAuthMiddleware(EnhancedJSONAuthMiddleware):
    ...
    def _get_default_rbac_rules(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "/approval-workflows/submit": {"POST": ["user", "team_admin", "org_admin"]},
            "/approval-workflows/approve": {"POST": ["team_admin", "org_admin"]},
            # Discussion rules
            "/comments/add": {"GET": ["user", "team_admin", "org_admin"]},  # GET-based for now
            "/comments/delete": {"GET": ["author", "team_admin", "org_admin"]},  # GET-based for now
            ...
            "/tag-suggester/suggest": {"GET": ["user", "team_admin", "org_admin"]},
            "/graph-rank/memories": {"GET": ["user", "team_admin", "org_admin"]},
        }
