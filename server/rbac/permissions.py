...
allow(Role.ADMIN, Resource.ORG, Action.READ, Action.UPDATE, Action.ADMINISTER, Action.INVITE, Action.CONFIGURE)
allow(Role.ADMIN, Resource.TEAM, Action.READ, Action.CREATE, Action.UPDATE, Action.DELETE, Action.ADMINISTER, Action.INVITE)
allow(Role.ADMIN, Resource.CONTEXT, Action.READ, Action.CREATE, Action.UPDATE, Action.DELETE, Action.SHARE, Action.EXPORT)
allow(Role.ADMIN, Resource.MEMORY, Action.READ, Action.CREATE, Action.UPDATE, Action.DELETE, Action.EXPORT)
allow(Role.ADMIN, Resource.USER, Action.READ, Action.CREATE, Action.UPDATE, Action.ADMINISTER, Action.INVITE)
allow(Role.ADMIN, Resource.INVITATION, Action.READ, Action.CREATE, Action.UPDATE, Action.DELETE, Action.APPROVE)
...
allow(Role.MAINTAINER, Resource.CONTEXT, Action.READ, Action.CREATE, Action.UPDATE, Action.DELETE, Action.SHARE, Action.EXPORT)
allow(Role.MAINTAINER, Resource.MEMORY, Action.READ, Action.CREATE, Action.UPDATE, Action.DELETE, Action.EXPORT)
...
allow(Role.MEMBER, Resource.CONTEXT, Action.READ, Action.CREATE, Action.UPDATE, Action.SHARE, Action.EXPORT)
allow(Role.MEMBER, Resource.MEMORY, Action.READ, Action.CREATE, Action.UPDATE, Action.EXPORT)
