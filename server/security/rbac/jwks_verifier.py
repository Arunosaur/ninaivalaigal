...
class JWKSVerifier:
    ...
    async def verify_with_replay_guard(self, token: str, nonce: Optional[str] = None) -> Dict[str, Any]:
        """
...
class JWKSVerifierPool:
    ...
    async def verify_token(self, token: str, issuer: Optional[str] = None) -> Dict[str, Any]:
...
async def verify_jwt_with_jwks(token: str, issuer: Optional[str] = None) -> Dict[str, Any]:
