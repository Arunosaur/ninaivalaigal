    ...
    def simulate_billing_operation(
        ...
        try:
            ...
            if operation == "create_subscription":
                ...
                response = self.framework.client.post(
                    "/billing-console/create-subscription", json=data, headers=headers
                )
...
class ConcurrentTestRunner:
    ...
    def run_all_tests(self) -> Dict[str, Any]:
        ...
        for endpoint, method in load_test_endpoints:
            load_result = self.load_scenarios.run_load_test(
                endpoint, method, duration_seconds=15, requests_per_second=5
            )
