...
class BillingFlowScenarios:
    ...
    def test_invoice_generation_flow(self):
        ...
        with (
            patch("server.invoice_management_api.REPORTLAB_AVAILABLE", True),
...
class BillingTestRunner:
    ...
    def run_all_tests(self) -> Dict[str, Any]:
        ...
        print(
            f"✅ Billing testing complete: {passed_tests}/{total_tests} tests passed ({results['summary']['pass_rate']}%)"
        )
