...
class TestDocumentationLinks:
    ...
    @pytest.fixture
    async def documentation_files(self):
    ...
    @pytest.fixture
    async def sample_markdown_content(self):
...
"""
    ...
    async def test_all_6_guides_committed_and_versioned(self, documentation_files):
        ...
        for doc_file in required_docs:
            ...
            assert doc_file.upper() == doc_file or "_" in doc_file, f"Documentation files should use UPPER_CASE naming: {doc_file}"

    async def test_reference_mapping_between_specs_and_code(self):
        ...
        spec_mapping = {
            "SPEC-007": {
                ...
                "test_files": [
                    "tests/foundation/spec_007/test_scope_hierarchy.py"
                ],
                "documentation": [
                    "docs/ARCHITECTURE_OVERVIEW.md#context-scope-system"
                ]
            },
            "SPEC-012": {
                ...
                "test_files": [
                    "tests/foundation/spec_012/test_substrate_lifecycle.py"
                ],
                "documentation": [
                    "docs/MEMORY_LIFECYCLE.md#substrate-management"
                ]
            },
            "SPEC-049": {
                ...
                "test_files": [
                    "tests/foundation/spec_049/test_sharing_workflows.py"
                ],
                "documentation": [
                    "docs/API_DOCUMENTATION.md#sharing-endpoints"
                ]
            }
        }
        ...
        for impl_file in all_implementation_files:
            mapped_specs = [
                spec_id for spec_id, spec_data in spec_mapping.items()
    ...
    async def test_full_contributor_onboarding_validated(self):
        ...
        assert onboarding_docs.intersection(expected_docs) == expected_docs, "Onboarding should cover all key documentation"

    async def test_link_check_code_sample_validation_openapi_syntax(self, sample_markdown_content):
        ...
        for language, code_content in code_blocks:
            if language == 'python':
                ...
                assert 'def ' in code_content or 'import ' in code_content or '=' in code_content, "Python code should have valid syntax elements"
            elif language == 'json':
    ...
    async def test_doc_ci_to_verify_on_each_commit_pr(self):
        ...
        for trigger in ci_triggers:
            assert trigger in ["push_to_main", "pull_request", "documentation_file_changes", "scheduled_daily"], f"Valid CI trigger: {trigger}"
    ...
    async def test_semantic_doc_completeness_via_prompt_based_review(self):
    ...
    async def test_automated_markdown_link_checker(self, sample_markdown_content):
    ...
    @pytest.mark.asyncio
    async def test_swagger_linter_integration(self):
