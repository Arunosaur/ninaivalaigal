...
async def foundation_test_config():
    ...
    return {
        "test_database_url": "postgresql://postgres:foundation_test@localhost:5432/foundation_test",
    ...
    class CoverageValidator:
        ...
        def generate_coverage_report(self):
            ...
            return {
                ...
                "average_coverage": sum(self.coverage_data.values()) / len(self.coverage_data) if self.coverage_data else 0,
