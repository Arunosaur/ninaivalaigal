...
class GetUserAnalyticsRequest(_message.Message):
    ...
    start_date: str
    end_date: str
    def __init__(self, user_id: _Optional[str] = ..., start_date: _Optional[str] = ..., end_date: _Optional[str] = ...) -> None: ...
...
class GetCohortRequest(_message.Message):
    ...
    end_date: str
    grouping: str
    def __init__(self, start_date: _Optional[str] = ..., end_date: _Optional[str] = ..., grouping: _Optional[str] = ...) -> None: ...
...
class UserAnalytics(_message.Message):
    ...
    def __init__(self, user_id: _Optional[str] = ..., total_memories: _Optional[int] = ..., total_api_calls: _Optional[int] = ..., total_storage_bytes: _Optional[int] = ..., daily_metrics: _Optional[_Iterable[_Union[DailyMetric, _Mapping]]] = ...) -> None: ...

class OrganizationAnalytics(_message.Message):
    __slots__ = ("organization_id", "total_users", "active_users", "total_memories", "total_api_calls", "total_revenue", "team_metrics")
    ORGANIZATION_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, organization_id: _Optional[str] = ..., total_users: _Optional[int] = ..., active_users: _Optional[int] = ..., total_memories: _Optional[int] = ..., total_api_calls: _Optional[int] = ..., total_revenue: _Optional[float] = ..., team_metrics: _Optional[_Iterable[_Union[TeamMetric, _Mapping]]] = ...) -> None: ...

class EngagementMetrics(_message.Message):
    __slots__ = ("daily_active_users", "weekly_active_users", "monthly_active_users", "retention_rate", "churn_rate", "engagement_timeline")
    ...
    def __init__(self, daily_active_users: _Optional[int] = ..., weekly_active_users: _Optional[int] = ..., monthly_active_users: _Optional[int] = ..., retention_rate: _Optional[float] = ..., churn_rate: _Optional[float] = ..., engagement_timeline: _Optional[_Iterable[_Union[EngagementPoint, _Mapping]]] = ...) -> None: ...
...
class CohortAnalysis(_message.Message):
    ...
    grouping: str
    def __init__(self, cohorts: _Optional[_Iterable[_Union[CohortGroup, _Mapping]]] = ..., grouping: _Optional[str] = ...) -> None: ...
...
class DailyMetric(_message.Message):
    ...
    storage_used: int
    def __init__(self, date: _Optional[str] = ..., api_calls: _Optional[int] = ..., memories_created: _Optional[int] = ..., storage_used: _Optional[int] = ...) -> None: ...
...
class TeamMetric(_message.Message):
    ...
    memories: int
    api_calls: int
    def __init__(self, team_id: _Optional[str] = ..., team_name: _Optional[str] = ..., members: _Optional[int] = ..., memories: _Optional[int] = ..., api_calls: _Optional[int] = ...) -> None: ...
...
class EngagementPoint(_message.Message):
    ...
    new_users: int
    churned_users: int
    def __init__(self, date: _Optional[str] = ..., active_users: _Optional[int] = ..., new_users: _Optional[int] = ..., churned_users: _Optional[int] = ...) -> None: ...
...
class CohortGroup(_message.Message):
    ...
    def __init__(self, cohort_id: _Optional[str] = ..., start_date: _Optional[str] = ..., initial_users: _Optional[int] = ..., retention_rates: _Optional[_Iterable[float]] = ..., lifetime_value: _Optional[float] = ...) -> None: ...
