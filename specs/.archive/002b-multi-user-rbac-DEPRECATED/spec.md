# ⚠️ **DEPRECATED — Superseded by SPEC-006**

This SPEC has been archived and is no longer authoritative.

For the complete and up-to-date specification on User Management, Authentication, and Signup flows, refer to:

👉 **[SPEC-006: User Signup & Organization Registration](../006-user-signup-system/spec.md)** (../006-user-signup-system/spec.md)
