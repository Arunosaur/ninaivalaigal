...
/**
 * Action to recall memories from ninaivalaigal for current context
 */
public class RecallAction extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        String memories = client.recall();
        Messages.showInfoDialog(
            project,
            memories,
            "Ninaivalaigal - Memories for " + client.getCurrentContext()
        );
