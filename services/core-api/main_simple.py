...
os.environ.setdefault("NINAIVALAIGAL_JWT_SECRET", "test-secret-key-for-development-only")
os.environ.setdefault("DATABASE_URL", "postgresql://user:password@localhost:5432/ninaivalaigal")
