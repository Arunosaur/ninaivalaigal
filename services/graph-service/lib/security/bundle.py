...
from security.idempotency.middleware import (
...
from security.multipart.starlette_adapter import process_multipart_securely
from security.utils.unicode_normalizer import normalize_unicode_for_detection
...
def apply_production_security(app: FastAPI, redis_url: str | None = None) -> None:
    ...
    if redis_url:
        try:
            ...
            from security.idempotency.redis_store import RedisKeyStore
