...
if BaseSettings is not None:
    ...
    class GraphServiceConfig(BaseSettings):
        """Graph Service configuration with Pydantic validation."""
    ...
    @lru_cache(maxsize=1)
    def load_config() -> GraphServiceConfig:
        """
        ...
        try:
            config = GraphServiceConfig(**file_values)
            return config
