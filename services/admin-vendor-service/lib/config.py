...
if BaseSettings is not None:
    ...
    class AdminVendorServiceConfig(BaseSettings):
        """Admin/Vendor Service configuration with Pydantic validation."""
    ...
    @lru_cache(maxsize=1)
    def load_config() -> AdminVendorServiceConfig:
        """
        ...
        try:
            config = AdminVendorServiceConfig(**file_values)
            return config
