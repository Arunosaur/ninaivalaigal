...
#
"""
Create Taiga user stories for SPEC-047: Narrative Memory Macros

This script creates stories for the narrative memory macro system including:
- Screen + audio recording integration
- Demo storage and memory type system
- Transcription and timeline generation
- Metadata management
- Web viewer/player
- CLI commands
- Upload pipeline
- API endpoints
- Memory context linking
- Database schema
- Integration tests
"""
...
# Epic configuration
EPIC_SUBJECT = "EPIC#026: Narrative Memory Macros (SPEC-047)"
STORIES_FILE = "scripts/spec047_stories.json"
...
def get_or_create_epic(auth_token, project_id):
    """Get or create epic for SPEC-047"""
    ...
    response = requests.post(
        ...
        json={
            ...
            "description": "Epic for SPEC-047: Narrative Memory Macros - Enables users to record screen + audio walkthroughs to be stored as narrative memories for demos, training, and procedural storytelling.",
            "tags": ["spec-047", "narrative-macros", "screen-capture", "demo", "recording"],
        },
    )
...
def main():
    """Main execution"""
    print("=" * 80)
    print("SPEC-047: Narrative Memory Macros - Taiga Story Creation")
    print("=" * 80)
    print()
