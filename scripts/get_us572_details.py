...
#
"""Get US#572 (SPEC-092) story details from Taiga"""
...
def main():
    ...
    # US#572 is the story for SPEC-092
    story_ref = 572
    ...
    output_file = "docs/spec-analysis/US572_STORY_DETAILS.json"
