...
#
"""Get US#570 (SPEC-090) story details from Taiga"""
...
def main():
    ...
    # US#570 is the story for SPEC-090
    story_ref = 570
    ...
    output_file = "docs/spec-analysis/US570_STORY_DETAILS.json"
