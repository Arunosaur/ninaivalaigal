...
#
"""Get US#574 (SPEC-096) story details from Taiga"""
...
def main():
    ...
    # US#574 is the story for SPEC-096
    story_ref = 574
    ...
    output_file = "docs/spec-analysis/US574_STORY_DETAILS.json"
