#!/usr/bin/env python3
"""
Verify and create/update Taiga story for SPEC-130: Terminal/CLI Auto Context Capture

This script:
1. Checks if US#601 exists in Taiga
2. Updates it if it exists (adds implementation status)
3. Creates new stories if needed
"""
...
def main():
    print("🔍 SPEC-130: Terminal/CLI Auto Context Capture - Story Verification\n")
    ...
    # Search for US#601
    print("🔍 Searching for US#601...")
    story = get_story_by_ref(token, project_id, 601)
    ...
    if story:
        ...
        print(f"   ℹ️  Story exists - manual update may be needed")
    else:
    ...
    print("\n✅ SPEC-130 story verification complete!")
