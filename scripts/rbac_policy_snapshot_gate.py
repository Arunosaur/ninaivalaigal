...
class RBACPolicyGate:
    ...
    def __init__(self, config: Optional[PolicyGateConfig] = None):
        ...
        try:
            ...
            for role_name, resources in current_matrix.items():
                for resource_name, permissions in resources.items():
                    ...
                    from tests.test_rbac_policy_snapshot import Role, Resource, Permission
    ...
    def load_baseline_snapshot(self) -> Optional[str]:
