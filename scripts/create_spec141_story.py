...
#
# Create Taiga story for SPEC-141: Mobile App Support
#
# Usage:
#     python3 scripts/create_spec141_story.py
...
def create_story(auth_token, project_id, ready_status_id):
    ...
    story_data = {
        ...
        "description": (
            "Native mobile application support for iOS and Android platforms, enabling users to "
            "access and interact with the platform through native mobile apps.\n\n"
            "**Key Features:**\n"
            ...
            "- Native Features: Push notifications, biometric auth, offline sync\n"
            "- Deep Linking: URL scheme support for deep navigation\n\n"
            "**Status:** Planned\n"
            "**Phase:** Phase 4\n"
            "**Category:** Mobile\n"
            "**Dependencies:** SPEC-080 (Offline Mode), SPEC-081 (Progressive Web App), SPEC-075 (Unified Frontend Architecture)"
        ),
        "status": ready_status_id,
        "tags": [["spec-141", None], ["mobile-app", None], ["mobile", None], ["ios", None], ["android", None]],
    }
...
def main():
    """Main execution."""
    print("🚀 Creating Taiga story for SPEC-141: Mobile App Support")
    print("=" * 60)
