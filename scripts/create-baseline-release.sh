...
echo ""
echo "2. Verify the tag on remote:"
echo "   git ls-remote --tags origin | grep $TAG_NAME"
echo ""
echo "3. Use this tag for rollback:"
echo "   BASELINE_TAG=$TAG_NAME ./scripts/rollback_on_regression.sh"
echo ""
echo -e "${GREEN}✅ Baseline release created successfully!${NC}"
echo ""
echo ""
