...
#
"""
Create Taiga User Stories for SPEC-028: Invoice Management System

Reuses the infrastructure from SPEC-026/027 story creation.
"""
...
# Configuration for SPEC-028
STORIES_FILE = Path(__file__).parent / "spec028_stories.json"
...
def main():
    print("=" * 60)
    print("SPEC-028 Taiga Story Creator (Invoice Management)")
    print("=" * 60)
    print()
    ...
    print(f"Loaded {len(stories)} invoice management story definitions")
    print()
