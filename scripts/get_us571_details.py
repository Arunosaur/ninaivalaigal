...
#
"""Get US#571 (SPEC-091) story details from Taiga"""
...
def main():
    ...
    # US#571 is the story for SPEC-091
    story_ref = 571
    ...
    output_file = "docs/spec-analysis/US571_STORY_DETAILS.json"
