...
#
"""
Create Taiga User Stories for SPEC-034: Memory Tags and Search Labels
"""
...
STORIES_FILE = Path(__file__).parent / "spec034_stories.json"
...
def main():
    print("=" * 70)
    print("SPEC-034: Memory Tags and Search Labels - Taiga Story Creation")
    print("=" * 70)
    print()
    ...
    print()
    print("✅ SPEC-034 story creation complete!")
