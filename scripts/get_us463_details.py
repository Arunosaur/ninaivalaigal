...
#
"""Get US#463 (SPEC-086) story details from Taiga"""
...
def main():
    ...
    # US#463 is the primary story for SPEC-086
    story_ref = 463
    ...
    output_file = "docs/spec-analysis/US463_STORY_DETAILS.json"
