...
#
"""
Create Taiga user stories for SPEC-046: Procedural Macro System

This script creates stories for the procedural macro system including:
- CLI macro commands
- Native automation capture
- Browser/IDE plugins
- Macro replay
...
# Epic configuration
EPIC_SUBJECT = "EPIC#025: Procedural Macro System (SPEC-046)"
STORIES_FILE = "scripts/spec046_stories.json"
...
def get_or_create_epic(auth_token, project_id):
    """Get or create epic for SPEC-046"""
    ...
    response = requests.post(
        ...
        json={
            ...
            "description": "Epic for SPEC-046: Procedural Macro System - Enables users to record repeatable task flows as procedural memory macros using the e^M agent, local OS integrations, or browser plugins.",
            "tags": ["spec-046", "macro", "automation", "procedural-memory"],
        },
    )
...
def main():
    """Main execution"""
    print("=" * 80)
    print("SPEC-046: Procedural Macro System - Taiga Story Creation")
    print("=" * 80)
    print()
