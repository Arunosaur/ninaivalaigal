...
#
"""Get US#573 (SPEC-094) story details from Taiga"""
...
def main():
    ...
    # Try US#573 first (speculative), then search
    story_ref = 573
    ...
    if not story:
        ...
        # Could add search logic here if needed
        return
    ...
    output_file = f"docs/spec-analysis/US573_STORY_DETAILS.json"
