...
export NINAIVALAIGAL_DATABASE_URL="postgresql://user:pass@db.company.com:5432/Ninaivalaigal_team"
...
```json
{
  "mcp.servers": {
    "Ninaivalaigal": {
      ...
      "env": {
        "NINAIVALAIGAL_DATABASE_URL": "postgresql://user:pass@server.company.com:5432/Ninaivalaigal_team",
